...
<div class="container py-5">
  <h2 class="text-center mb-4">Evaluacion de candidatos</h2>
  <p class="text-center text-muted mb-5">gestion de los candidatos </p>
  ...
  <div class="row justify-content-center g-4">
    ...
    <div class="col-md-4">
      <div class="custom-card h-100 text-center">
        ...
        <h5>Registrar candidatos</h5>
        <p>Registra un nuevo candidato con toda su informacion personal, academica y laboral. </p>
        <a href="crear_solicitud.php" class="btn btn-primary w-100">Registrar Candidato</a>
      </div>
    </div>
    ...
    <div class="col-md-4">
      <div class="custom-card h-100 text-center">
        ...
        <h5>Ver candidatos registrados </h5>
    ...
    <div class="col-md-4">
      <div class="custom-card h-100 text-center">
        <i class="fas fa-users-cog fa-2x mb-3 text-primary"></i>
        <h5> Evaluaciones de las solicitudes</h5>
        <p>Se selecciona la solicitud y se procesan en base a los candidatos y sus registro</p>
        <a href="lista_solicitudes.php" class="btn btn-primary w-100">Ver Lista de solicitudes</a>
      </div>
    </div>
