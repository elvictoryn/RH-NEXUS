...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary px-4">
  ...
  <a class="navbar-brand fw-bold" href="<?= base_url('app/views/admin/index.php') ?>">Nexus RH</a>
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    ...
    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?= base_url('app/views/admin/usuarios/menu.php') ?>">
          <i class="fas fa-users me-1"></i>Usuarios
        </a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="<?= base_url('app/views/admin/departamentos/menu.php') ?>">
          <i class="fas fa-sitemap me-1"></i>Administración de Departamentos
        </a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="<?= base_url('app/views/admin/solicitudes/index.php') ?>">
          <i class="fas fa-envelope me-1"></i>Solicitudes
        </a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="<?= base_url('app/views/admin/evaluaciones/index.php') ?>">
          <i class="fas fa-check-circle me-1"></i>Evaluaciones
        </a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="<?= base_url('app/views/admin/resultados/index.php') ?>">
          <i class="fas fa-chart-line me-1"></i>Resultados
        </a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="<?= base_url('app/views/admin/ia/index.php') ?>">
    ...
    <div class="d-flex text-white">
      ...
      <a href="<?= base_url('public/logout.php') ?>" class="btn btn-light btn-sm">Cerrar sesión</a>
    </div>
  </div>
</nav>
